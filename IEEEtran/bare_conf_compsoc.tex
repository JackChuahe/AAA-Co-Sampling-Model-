...
\section{Optimal}
In this section, we decompose the IMM into three sub-problems: K sampling point election, Slot time allocation, node cooperative sampling optimization, and corresponding three heuristic algorithms are proposed to form the approximate optimal solution of the IMM model.
